<h1 align="center" style="color: Navy">SpringMVC</h1>
...
![image-20210706201316593](images/img003.png)
...
![image-20210706201602267](images/img004.png)
...
1. 创建属性文件jdbc.properties
   一定要加前缀，否则username会被spring解析为电脑用户名
    ```properties
    jdbc.url=jdbc:mysql://localhost:3306/ssm?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT&rewriteBatchedStatements=TRUE
    jdbc.username=root
    jdbc.password=123456
    jdbc.driverClassName=com.mysql.cj.jdbc.Driver
    ```
2. 配置mybatis-config.xml（大部分配置都交由spring管理了）
   ```xml
    <settings>
        <!--    将下划线映射为驼峰    -->
